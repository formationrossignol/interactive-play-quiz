...
import { BellRing, BookOpenCheck, Megaphone, Share2 } from "lucide-react";
...
const OPTIONS: {
  ...
  { key: "sharesEnabled", title: "Partages et collaboration", body: "Invitations et nouveaux droits sur un contenu.", icon: Share2 },
  { key: "examsEnabled", title: "Examens", body: "Nouvelles copies et activité des participants.", icon: BookOpenCheck },
  { key: "supportEnabled", title: "Support", body: "Suivi et résolution de vos demandes.", icon: BellRing },
  { key: "productEnabled", title: "Nouveautés produit", body: "Versions et améliorations importantes.", icon: Megaphone },
];
...
export function NotificationPreferencesPanel({
  ...
  return (
    <div style={{ display: "grid" }}>
      {OPTIONS.map(({ key, title, body, icon: Icon }) => (
