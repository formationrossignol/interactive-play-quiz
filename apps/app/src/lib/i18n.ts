...
export const translations = {
  en: {
    ...
    navGroupCollab: "Collaboration",
    navGroupCorrection: "Grading",
    navGroupDiscover: "Discover",
    navGroupAccount: "Account",
    navGroupSupport: "Support",
    navTools: "Tools",
    creationTypeQuiz: "Quiz",
    creationTypePoll: "Polls",
    creationTypeFlashcard: "Flashcards",
    creationTypeSlide: "Slides",
    creationTypeCourse: "Courses",
    creationTypeLearningPath: "Learning paths",
    ...
    commandPalettePlaceholder: "Jump to a page or action…",
    commandPaletteEmpty: "No matches",
    commandPaletteNavGroup: "Go to",
    commandPaletteCreateGroup: "Create",
    commandPaletteContentGroup: "Content",
    ...
    navGroups: "Groups",
    navSignatures: "Signatures",
    navManualGrading: "Grade entry",
    navMyGrades: "My grades",
    navExamQueue: "Submissions to review",
    sharedWithMeSubtitle: "Courses shared with you",
    sharedWithMeEmpty: "No courses have been shared with you yet",
    createNew: "Create",
    createGroupAssess: "Assess",
    createGroupTrain: "Train",
    navCreateQuiz: "Quiz",
    navCreatePoll: "Poll",
    createFlashcards: "Flashcards",
    createSlides: "Slides",
    createCourse: "Course",
    createLearningPath: "Learning path",
    createExam: "Exam",
    admin: "Admin",
    back: "Back",
    save: "Save",
    ...
    footerDescription: "Brivia helps teams design interactive moments that energize audiences anywhere.",
    ...
    footerRights: "Brivia. All rights reserved.",
    ...
    mySlides: "My Slides",
    mySlidesSubtitle: "Review and manage your presentations",
    ...
    siteTheme: "Application theme",
    siteThemeHint: "Previewed instantly and saved with your profile",
    theme: "Theme",
    lightMode: "Light",
    darkMode: "Dark",
    density: "Density",
    ...
    explorerResultsHeading: "Results",
    ...
    explorerTemplates: "My templates",
    ...
    explorerNoTemplatesTitle: "No templates yet",
    explorerNoTemplatesBody: "Save a {item} as a template from its editor to find it here.",
  ...
  fr: {
    ...
    navGroupExplore: "Explorer",
    navGroupCollab: "Collaboration",
    navGroupCorrection: "Correction",
    navGroupDiscover: "Découvrir",
    navGroupAccount: "Compte",
    navGroupSupport: "Support",
    navTools: "Outils",
    creationTypeQuiz: "Quiz",
    creationTypePoll: "Sondages",
    creationTypeFlashcard: "Flashcards",
    creationTypeSlide: "Slides",
    creationTypeCourse: "Cours",
    creationTypeLearningPath: "Parcours",
    ...
    commandPalettePlaceholder: "Aller à une page ou une action…",
    commandPaletteEmpty: "Aucun résultat",
    commandPaletteNavGroup: "Aller à",
    commandPaletteCreateGroup: "Créer",
    commandPaletteContentGroup: "Contenu",
    ...
    navGroups: "Groupes",
    navSignatures: "Signatures",
    navManualGrading: "Saisie des notes",
    navMyGrades: "Mes notes",
    navExamQueue: "Copies à examiner",
    sharedWithMeSubtitle: "Cours partagés avec vous",
    sharedWithMeEmpty: "Aucun cours partagé pour l'instant",
    createNew: "Créer",
    createGroupAssess: "Évaluer",
    createGroupTrain: "Former",
    navCreateQuiz: "Quiz",
    navCreatePoll: "Sondage",
    createFlashcards: "Flashcards",
    createSlides: "Slides",
    createCourse: "Cours",
    createLearningPath: "Parcours",
    createExam: "Examen",
    admin: "Admin",
    back: "Retour",
    save: "Enregistrer",
    ...
    footerDescription: "Brivia aide les équipes à créer des moments interactifs qui dynamisent leurs audiences.",
    ...
    footerRights: "Brivia. Tous droits réservés.",
    ...
    mySlides: "Mes Slides",
    mySlidesSubtitle: "Gérez et retrouvez vos présentations",
    ...
    siteTheme: "Thème de l’application",
    siteThemeHint: "Prévisualisé instantanément et enregistré avec votre profil",
    theme: "Thème",
    lightMode: "Clair",
    darkMode: "Sombre",
    density: "Densité",
    ...
    explorerResultsHeading: "Résultats",
    ...
    explorerNoTemplatesTitle: "Aucun modèle",
    explorerNoTemplatesBody: "Enregistrez un {item} comme modèle depuis son éditeur pour le retrouver ici.",
